class PagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @page.save
        ...
        format.json { render :show, status: :created, location: book_page_path(@book,@page) }
      else
  ...
  def destroy
    @page.destroy
    respond_to do |format|
      format.html { redirect_to book_pages_path, notice: 'Page was successfully destroyed.' }
